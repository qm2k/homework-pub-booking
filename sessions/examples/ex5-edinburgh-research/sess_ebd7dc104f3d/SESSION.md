# Session sess_ebd7dc104f3d

**Scenario:** edinburgh-research
**Created:** 2026-05-25T20:47:09.264188+00:00
...
IMPORTANT: Do NOT over-decompose this task into multiple subgoals. Keep all steps (research, calculation, and flyer generation) in a SINGLE subgoal assigned to the 'loop' half. The executor does not share state across subgoals.
When writing the subgoal description, INCLUDE all specific constraints (exact date, time, party size, area, and budget) so the executor knows them.

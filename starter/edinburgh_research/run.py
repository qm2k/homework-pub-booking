    ...
    with example_sessions_dir("ex5-edinburgh-research", persist=real) as sessions_root:
        session = create_session(
            ...
            task=(
                ...
                "IMPORTANT: Do NOT over-decompose this task into multiple subgoals. "
                "Keep all steps (research, calculation, and flyer generation) in a SINGLE "
                "subgoal assigned to the 'loop' half. The executor does not share state across subgoals.\n"
                "When writing the subgoal description, INCLUDE all specific constraints "
                "(exact date, time, party size, area, and budget) so the executor knows them.\n\n"
